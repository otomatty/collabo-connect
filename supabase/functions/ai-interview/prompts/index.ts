import type { JobTypePrompt, ProfileData, PastResponse } from "./types.ts";
import { webEngineerPrompt } from "./web-engineer.ts";
import { salesforceEngineerPrompt } from "./salesforce-engineer.ts";
import { pmPmoPrompt } from "./pm-pmo.ts";
import { salesPrompt } from "./sales.ts";
import { backOfficePrompt } from "./back-office.ts";
import { defaultPrompt } from "./default.ts";

export type { JobTypePrompt, ProfileData, PastResponse };
...
// ---------- 事前回答フォーマット ----------
export function formatPastResponses(pastResponses?: PastResponse[]): string {
