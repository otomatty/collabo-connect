...
INSERT INTO public.ai_questions (id, question, options, date) VALUES
  ('00000000-0000-0000-0000-000000000031', '最近チャレンジしてみたいことは？', array['新しい技術の習得', '副業・個人開発', '健康・フィットネス', '新しい趣味'], '2026-03-05'),
  ('00000000-0000-0000-0000-000000000032', 'チームで働く時に一番嬉しい瞬間は？', array['リリースが成功した時', '感謝された時', 'コードレビューで学びがあった時', '雑談が盛り上がった時'], '2026-03-04'),
  ('00000000-0000-0000-0000-000000000033', '仕事終わりの楽しみは？', array['美味しいご飯', 'ゲーム・動画', '運動・散歩', '読書・勉強'], '2026-03-03'),
  ('00000000-0000-0000-0000-000000000034', 'AIツールを普段使っていますか？', array['毎日使っている', '週に数回', 'たまに試す程度', 'まだ使っていない'], '2026-03-02'),
